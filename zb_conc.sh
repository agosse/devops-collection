...
while true; do
    case "$1" in
        ...
        --idle-conc|-i ) IDLE_CONC="$2"; shift 2 ;;
        --idle-linger|-l ) IDLE_LINGER="$2"; shift 2 ;;
        --busy-conc|-b ) BUSY_CONC="$2"; shift 2 ;;
        --ssh-user|-u ) SSH_USER="$2"; shift 2 ;;
        --ssh-host|-h ) SSH_HOSTS+=("$2"); shift 2 ;;
        --sut-url|-s ) SUT_URLS+=("$2"); shift 2 ;;
        -- ) shift; break ;;
        * ) break ;;
    esac
done
...
# Build a list of forked processes
IDLE_PIDS=()
BUSY_PIDS=()
